...
namespace UserData {
    ...
    public class User {
        ...
        public User(string username, string password, string fullName, string hashcode, DoctorType type) {
            ...
            this.Hashcode = Encoding.Unicode.GetString(Encoding.Unicode.GetBytes(hashcode));
            this.Type = type;
        }
        ...
        public User(string username, string password, string fullName) {
            ...
            Hashcode = Encoding.Unicode.GetString(new SHA256Managed().ComputeHash(Encoding.Unicode.GetBytes(DateTime.UtcNow.Ticks.ToString())));
        }
